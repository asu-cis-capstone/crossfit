...
namespace WodstarMobileApp.Droid
{
	public static class Util
	{
		...
		public static WodstarMobileApp.UserJournal demoentry3 = new UserJournal (thisUser.id, WorkoutUtil.wodType, WorkoutUtil.franId, WorkoutUtil.forTime, "Fran", "5:09.16");
		public static WodstarMobileApp.UserJournal demoentry4 = new UserJournal (thisUser.id, WorkoutUtil.wodType, WorkoutUtil.franId, WorkoutUtil.forTime, "Fran", "3:51.27");
		public static WodstarMobileApp.UserJournal demoentry5 = new UserJournal (thisUser.id, WorkoutUtil.wodType, WorkoutUtil.franId, WorkoutUtil.forTime, "Fran", "4:39.46");

		public static WodstarMobileApp.UserJournal demoentry6 = new UserJournal (thisUser.id, WorkoutUtil.wodType, WorkoutUtil.warFrankId, WorkoutUtil.forTime, "War Frank", "8:21:43");
		public static WodstarMobileApp.UserJournal demoentry7 = new UserJournal (thisUser.id, WorkoutUtil.wodType, WorkoutUtil.warFrankId, WorkoutUtil.forTime, "War Frank", "8:21:43");
		public static WodstarMobileApp.UserJournal demoentry8 = new UserJournal (thisUser.id, WorkoutUtil.wodType, WorkoutUtil.warFrankId, WorkoutUtil.forTime, "War Frank", "8:21:43");
